...
1. First we try to create some prompts to use as system prompts or slash commands or sub-agents in claude code for ex to analyze some basic concepts of code
